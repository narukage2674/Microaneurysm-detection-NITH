...
class FCM():
    ...
    def segmentImage(self):
        ...
        result = self.deFuzzify()
        self.result = result.reshape(self.shape).astype('uint8')
...
if __name__ == '__main__':
    ...
    img=Image.open('C:/Users/Anurag/datasets/Ppd/C0003222.jpg')
    # img_gray = img.convert('L') #Converting to grayscale
    img_arr = np.array(img)

    cluster = FCM(img_arr,3,m=2,epsilon=.05,max_iter=100,kernel_shape='uniform',
            kernel_size=9)
